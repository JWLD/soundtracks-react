...
The main purpose of this app (outside of practicing react...!) is to render the data in a simple easy-to-browse interface. I've created a [second app](https://github.com/JWLD/data-react) to make sourcing this data from different APIs as easy as possible.
